...
public class KioskDatabase extends SQLiteOpenHelper {
    ...
    private void insertKioskConfig(SQLiteDatabase db, String insertConfig) {
        db.execSQL(insertConfig, new Object[]{ConfigurationKey.KIOSK_ID.name(), "kiosk_name"});
        ...
        db.execSQL(insertConfig, new Object[]{ConfigurationKey.SERVER_URL.name(), "http://128.199.36.86:8080/dloserver"});
