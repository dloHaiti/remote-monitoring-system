...
public class CustomerAccountRepositoryTest {
    ...
    public void shouldReturnAllCustomerAccountsInSetInAlphabeticalOrder() {
        ...
        List<CustomerAccount> customerAccounts = asList(
                new CustomerAccount(1L, "Name 1", "Contact Name 1", "Address 1", "Phone 1", (long) 11,0).withChannelIds(asList(1L)),
                new CustomerAccount(2L, "Name 2", "Contact Name 2", "Address 2", "Phone 2", (long) 22,1).withChannelIds(asList(2L)));
        ...
        assertThat(list,
                is(sortedSet(
                        new CustomerAccount(1L, "Name 1", "Contact Name 1", "Address 1", "Phone 1", (long) 11,1).withChannelIds(asList(1L)),
                        new CustomerAccount(2L, "Name 2", "Contact Name 2", "Address 2", "Phone 2", (long) 22,0).withChannelIds(asList(2L)))));
    ...
    public void shouldReplaceAll() {
        ...
        assertThat(initialList,
                is(sortedSet(new CustomerAccount(1L, "Name 1", "Contact Name 1", "Address 1", "Phone 1", (long) 11,0).withChannelIds(asList(1L)),
                        new CustomerAccount(2L, "Name 2", "Contact Name 2", "Address 2", "Phone 2", (long) 22,0).withChannelIds(asList(2L)))));
        ...
        boolean success = repository.replaceAll(asList(
                new CustomerAccount(1L, "Name 3", "Contact Name 3", "Address 3", "Phone 3", (long) 33,0).withChannelIds(asList(3L)),
                new CustomerAccount(2L, "Name 4", "Contact Name 4", "Address 4", "Phone 4", (long) 44,0).withChannelIds(asList(4L))));

        assertThat(success, is(true));
        SortedSet<CustomerAccount> updatedList = repository.findAll();
        assertThat(updatedList,
                is(sortedSet(new CustomerAccount(1L, "Name 3", "Contact Name 3", "Address 3", "Phone 3", (long) 33,0).withChannelIds(asList(3L)),
                        new CustomerAccount(2L, "Name 4", "Contact Name 4", "Address 4", "Phone 4", (long) 44,0).withChannelIds(asList(4L)))));
