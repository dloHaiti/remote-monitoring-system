...
public class ParameterTest {
    ...
    private static Parameter buildParameter() {
        return new Parameter("a", "", "", "", false,false, 1);
    }
    ...
    public void shouldConsiderInvalidNumberBelowMinimumWithRange() {
        Parameter p = new Parameter("a", "", "5.0", "10.0", false,false ,1);
    ...
    public void shouldHaveNaturalSortOrderByPriority() {
        Parameter a = new Parameter("a", "", "", "", false, false,100);
        Parameter b = new Parameter("b", "", "", "", false, false,1);
    ...
    public void shouldSortAnyPriorityAheadOfNullPriority() {
        Parameter a = new Parameter("a", "", "", "", false,false, null);
        Parameter b = new Parameter("a", "", "", "", false,false, 1);
    ...
    public void shouldHaveNaturalAlphabeticalSortOrderWhenSamePriority() {
        Parameter a = new Parameter("a", "", "", "", false,false, 1);
        Parameter b = new Parameter("b", "", "", "", false,false, 1);
    ...
    public void shouldHandleNullParameterNamesGracefully() {
        Parameter a = new Parameter("a", "", "", "", false,false, 1);
        Parameter n = new Parameter(null, "", "", "", false,false, 1);
